...
module.exports = {
  ...
  plugins: [
    ...
    // Incorporates all webpack-generated javascipt as defered <script> elements.
    new ScriptExtHtmlWebpackPlugin({
      defer: /\.js$/,
    }),
    // Move the CSS content generated by ExtractTextPlugin
    // from an external CSS file to an internal `<style>` element.
